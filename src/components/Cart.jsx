...
const Cart = () => {
    ...
    return (
        <WrapperCart>
            ...
            <Top>
                <Link to='/'><TopButton>Volver al menú principal</TopButton></Link>
                {
                    (test.cartList.length > 0)
                    ? <TopButton type="filled" onClick={test.removeList}>Eliminar la lista de compras</TopButton>
            ...
            <Bottom>
                <Info>
                    {
                        test.cartList.length > 0 &&
                            ...
                            <PriceDetail>
                                ...
                                <ProductAmount>{item.nnItem} producto(s)</ProductAmount>
                                /
                ...
                </Info>
                {
                    test.cartList.length > 0 &&
                        <Summary>
                            <SummaryTitle>Lista de Compra</SummaryTitle>
                            <SummaryItem>
                                <SummaryItemText>Subtotal</SummaryItemText>
                                <SummaryItemPrice><Formato number={test.calcSubTotal()} /></SummaryItemPrice>
                            </SummaryItem>
                            <SummaryItem>
                                <SummaryItemText>Impuesto IVA</SummaryItemText>
                                <SummaryItemPrice><Formato number={test.calcTaxes()} /></SummaryItemPrice>
                            </SummaryItem>
                            {/* <SummaryItem>
